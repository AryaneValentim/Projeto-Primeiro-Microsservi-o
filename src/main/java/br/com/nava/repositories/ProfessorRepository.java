...
// ORM -> Object Relational Mapping
	...
	//find byindica que o spring ira montar o sql
	//select * from professores where nome like '%nome%' and rua = *rua*
	public List<ProfessorEntity> findByNomeContainsAndRua(String nome, String rua);
